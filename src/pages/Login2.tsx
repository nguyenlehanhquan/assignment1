...
import { setAuthToken } from '../utils/auth.ts'; // Import hàm setAuthToken
...
const Login2: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        e.preventDefault();
        // Logic gọi API để đăng nhập
        try {
            // Ví dụ: Giả định gọi API thành công và nhận được token
            ...
            //   setAuthToken(data.token); // Lưu token
            //   navigate('/profile'); // Chuyển hướng đến trang profile sau khi đăng nhập
            // } else {
            //   alert('Đăng nhập thất bại: ' + data.message);
            // }

            // ---- Dưới đây là logic giả lập đăng nhập thành công ----
            const fakeToken = 'your_super_secret_jwt_token_here_12345'; // Thay bằng token thật
            setAuthToken(fakeToken); // Lưu token giả lập
            alert('Đăng nhập thành công!');
            navigate('/profile'); // Chuyển hướng đến trang thông tin cá nhân (ví dụ: /profile)
            // --------------------------------------------------------
    ...
    return (
        // ... (Phần giao diện Login giữ nguyên) ...
        <div className="min-h-screen bg-green-900 flex flex-col items-center justify-center p-4">
            ...
            <div className="w-full max-w-md flex justify-center mb-8">
                ...
                <img src="/tazajmart_logo.svg" alt="Tazajmart Logo" className="h-10" />
            </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-xl w-full max-w-md">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="relative">
                        ...
                        >
                            {showPassword ? (
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                                    <path fillRule="evenodd" d="M3.707 2.293a1 1 0 00-1.414 1.414L5.586 7.5a1 1 0 010 1.414l-3.293 3.293a1 1 0 101.414 1.414l3.293-3.293a1 1 0 011.414 0l3.293 3.293a1 1 0 001.414-1.414l-3.293-3.293a1 1 0 010-1.414l3.293-3.293a1 1 0 10-1.414-1.414L8.414 6.5A1 1 0 017 6.086L3.707 2.293zM10 12a2 2 0 100-4 2 2 0 000 4z" clipRule="evenodd" />
                                </svg>
                            )}
                        </button>
                    </div>
                    ...
                    <div className="text-right">
                        <a href="#" className="text-sm text-green-700 hover:underline">Quên mật khẩu?</a>
                    </div>
                ...
                <p className="mt-8 text-center text-gray-600 text-sm">
                    ...
                    <a href="/signup" className="text-green-700 hover:underline font-semibold">Đăng ký ngay</a>
                </p>
            </div>
        </div>
    );
