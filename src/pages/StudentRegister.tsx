        ...
        <div className="w-5/6 flex flex-col items-center justify-center">
          ...
          <div className="relative w-full mb-4">
            ...
            <input
              ...
              className="border border-gray-300 rounded-md w-full p-2 pl-9"
            />
          </div>
          ...
          <button className="bg-gradient-to-r from-yellow-400 to-yellow-600 text-amber-50 font-bold w-full rounded-md m-3 h-10">
            Vào thi
          </button>
          <Link to="/">
