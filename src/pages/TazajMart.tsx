            ...
            <div className="flex flex-col w-[1600px] gap-2">
                <div className="flex gap-10 justify-between items-center h-14 my-5">
                    ...
                    <div className="relative">
                        ...
                        <input type="search" placeholder="Search your products, Categories or Brands" className="w-[900px] h-[50px] rounded-3xl pl-12 bg-gray-100"/>
                    </div>
                ...
                <div className="flex flex-col gap-5 my-7">
                    ...
                    <div className="flex justify-between text-green-900 font-medium">
                        <div className="flex gap-5">
                            <button className="text-green-900 bg-gray-100 px-4 py-1 rounded-[7px] hover:text-white hover:bg-green-900">All Categories</button>
                            <button className="text-green-900 bg-gray-100 px-4 py-1 rounded-[7px] hover:text-white hover:bg-green-900">Price</button>
                            <button className="text-green-900 bg-gray-100 px-4 py-1 rounded-[7px] hover:text-white hover:bg-green-900">Review</button>
                            <button className="text-green-900 bg-gray-100 px-4 py-1 rounded-[7px] hover:text-white hover:bg-green-900">Color</button>
                            <button className="text-green-900 bg-gray-100 px-4 py-1 rounded-[7px] hover:text-white hover:bg-green-900">Offer</button>
                            <button className="text-green-900 bg-gray-100 px-4 py-1 rounded-[7px] hover:text-white hover:bg-green-900">Brands</button>
                        </div>
                        <button className="border-2 border-green-900 px-4 py-1 rounded-[7px] hover:text-white hover:bg-green-900">Sort by</button>
                    </div>
                </div>
                <div className="grid grid-cols-4 gap-8">
                    <div className="rounded-[12px] bg-gray-100 shadow">
                        ...
                        <div className="p-3 flex flex-col gap-3">
                            <div className="h-[300px] flex items-center justify-center">
                                <img src={greenPepper}  alt="tazajmart_product1" className="object-contain h-[300px] w-auto"/>
                            </div>
                            <h1 className="font-bold text-green-900 text-xl">Organic Green Big Sweet Pepper Seeds - Capsicum</h1>
                    ...
                    <div className="rounded-[12px] bg-gray-100 shadow">
                        ...
                        <div className="p-3 flex flex-col gap-3">
                            <div className="h-[300px] flex items-center justify-center">
                                <img src={instantNoodle}  alt="tazajmart_product2" className="object-contain h-[300px] w-auto"/>
                            </div>
                            <h1 className="font-bold text-green-900 text-xl">Seoul Yopokki Spicy 4 flavors of Korean Topokki</h1>
                            <div className="flex flex-col gap-2">
                                <div className="flex justify-between">
                    ...
                    <div className="rounded-[12px] bg-gray-100 shadow">
                        ...
                        <div className="p-3 flex flex-col gap-3">
                            <div className="h-[300px] flex items-center justify-center">
                                <img src={banana}  alt="tazajmart_product2" className="object-contain h-[300px] w-auto"/>
                            </div>
                            <h1 className="font-bold text-green-900 text-xl">The banana cavendish fruit is very popular in Malaysia</h1>
                            <div className="flex flex-col gap-2">
                                <div className="flex justify-between">
                    ...
                    <div className="rounded-[12px] bg-gray-100 shadow">
                        ...
                        <div className="p-3 flex flex-col gap-3">
                            <div className="h-[300px] flex items-center justify-center">
                                <img src={avocado}  alt="tazajmart_product2" className="object-contain h-[300px] w-auto"/>
                            </div>
                            <h1 className="font-bold text-green-900 text-xl">Organic 100% Italian hass 100% natural Avocado</h1>
                            <div className="flex flex-col gap-2">
                                <div className="flex justify-between">
                                    <p className="text-gray-400 font-medium">1000gm</p>
                                    <p className="text-green-900 font-medium flex items-center gap-2">
                    ...
                    <div className="rounded-[12px] bg-gray-100 shadow">
                        ...
                        <div className="p-3 flex flex-col gap-3">
                            <div className="h-[300px] flex items-center justify-center">
                                <img src={ricePack}  alt="tazajmart_product2" className="object-contain h-[300px] w-auto"/>
                            </div>
                            <h1 className="font-bold text-green-900 text-xl">Mahin Brand, Extra Long Grain Basmati Rice</h1>
                            <div className="flex flex-col gap-2">
                                <div className="flex justify-between">
                    ...
                    <div className="rounded-[12px] bg-gray-100 shadow">
                        ...
                        <div className="p-3 flex flex-col gap-3">
                            <div className="h-[300px] flex items-center justify-center">
                                <img src={lemon}  alt="tazajmart_product2" className="object-contain h-[300px] w-auto"/>
                            </div>
                            <h1 className="font-bold text-green-900 text-xl">Lemon Big imported from South Africa</h1>
                            <div className="flex flex-col gap-2">
                                <div className="flex justify-between">
                                    <p className="text-gray-400 font-medium">4pc</p>
                                    <p className="text-green-900 font-medium flex items-center gap-2">
                    ...
                    <div className="rounded-[12px] bg-gray-100 shadow">
                        ...
                        <div className="p-3 flex flex-col gap-3">
                            <div className="h-[300px] flex items-center justify-center">
                                <img src={greenTea}  alt="tazajmart_product2" className="object-contain h-[300px] w-auto"/>
                            </div>
                            <h1 className="font-bold text-green-900 text-xl">Lipton Lemon Green Tea Imported From China</h1>
                            <div className="flex flex-col gap-2">
                                <div className="flex justify-between">
                    ...
                    <div className="rounded-[12px] bg-gray-100 shadow">
                        ...
                        <div className="p-3 flex flex-col gap-3">
                            <div className="h-[300px] flex items-center justify-center">
                                <img src={chips}  alt="tazajmart_product2" className="object-contain h-[300px] w-auto"/>
                            </div>
                            <h1 className="font-bold text-green-900 text-xl">Lay's Tomato Ketchup Chips 12 pack Family Size</h1>
                            <div className="flex flex-col gap-2">
                                <div className="flex justify-between">
                                    <p className="text-gray-400 font-medium">4pc</p>
                                    <p className="text-green-900 font-medium flex items-center gap-2">
                    ...
                    <div className="rounded-[12px] bg-gray-100 shadow">
                        ...
                        <div className="p-3 flex flex-col gap-3">
                            <div className="h-[300px] flex items-center justify-center">
                                <img src={beef}  alt="tazajmart_product1" className="object-contain h-[300px] w-auto"/>
                            </div>
                            <h1 className="font-bold text-green-900 text-xl">Arabian best Beef Meat Kirkland Signature Roast</h1>
                            <div className="flex flex-col gap-2">
                                <div className="flex justify-between">
                    ...
                    <div className="rounded-[12px] bg-gray-100 shadow">
                        ...
                        <div className="p-3 flex flex-col gap-3">
                            <div className="h-[300px] flex items-center justify-center">
                                <img src={honey}  alt="tazajmart_product1" className="object-contain h-[300px] w-auto"/>
                            </div>
                            <h1 className="font-bold text-green-900 text-xl">APILIFE - Flavorful & Nutritious! Black Seed Honey</h1>
                            <div className="flex flex-col gap-2">
                                <div className="flex justify-between">
                    ...
                    <div className="rounded-[12px] bg-gray-100 shadow">
                        ...
                        <div className="p-3 flex flex-col gap-3">
                            <div className="h-[300px] flex items-center justify-center">
                                <img src={milk}  alt="tazajmart_product2" className="object-contain h-[300px] w-auto"/>
                            </div>
                            <h1 className="font-bold text-green-900 text-xl">Tazaj Mart Full Cream Fresh Australian Milk</h1>
                            <div className="flex flex-col gap-2">
                                <div className="flex justify-between">
                                    <p className="text-gray-400 font-medium">4pc</p>
                                    <p className="text-green-900 font-medium flex items-center gap-2">
